...
namespace AKS_CourseBooking
{
    public class AKSHttpHelper
    {
        ...
        /// <returns></returns>
        public static CBResponse Request(string TUID, string COID, string UID, string targetTime)
        {
            ...
            try
            {
                ...
                Console.ResetColor();
                CBResponse response = Newtonsoft.Json.JsonConvert.DeserializeObject<CBResponse>(str);
