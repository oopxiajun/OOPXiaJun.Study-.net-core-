...
{
    public class AKSHttpHelper
    {
        public static long GetTimestamp(DateTime date)
        {
            DateTime Jan1st1970 = new DateTime(1970, 1, 1, 0, 0, 0, DateTimeKind.Utc);
            long t = (long)(date.AddHours(-8) - Jan1st1970).TotalSeconds;
            return t;
        }
        ...
        /// 预约
        /// </summary>
        /// <param name="TUID">老师id</param>
        /// <param name="COID">课程id</param>
        /// <param name="UID">用户id</param>
        /// <param name="targetTime">上课时间</param>
        /// <returns></returns>
        public static CBResponse<CBResponse_Value> AppointClass(string TUID, string COID, string UID, string targetTime)
        {

            long t = GetTimestamp(DateTime.Now);
            string _timestamp = t + "";
            ...
            nameValueCollection.Add("TUID", TUID);//老师id"86632"
            nameValueCollection.Add("bookingWay", "3");
            nameValueCollection.Add("COID", COID);//课程id"2031295"
            nameValueCollection.Add("UID", UID);//用户id "3159868"
            nameValueCollection.Add("targetTime", "\"" + targetTime + "\"");//预约时间点\"2019-10-20 22:30\"
            nameValueCollection.Add("classtool", "8");//上课方式8:A-classroom  ,7:class-in
            ...
            try
            {
                ...
                Console.ResetColor();
                CBResponse<CBResponse_Value> response = Newtonsoft.Json.JsonConvert.DeserializeObject<CBResponse<CBResponse_Value>>(str);
        ...
        public static CBResponse<Dictionary<DateTime, dynamic>> GetTargetTimeAvaDuration(string TUID, string TargetTime, string COID)
        {
            ...
            System.Collections.Specialized.NameValueCollection nameValueCollection = new System.Collections.Specialized.NameValueCollection();
            nameValueCollection.Add("TUID", TUID);//老师id"86632"
            nameValueCollection.Add("TargetTime", "\"" + TargetTime + "\"");
            nameValueCollection.Add("COID", COID);//课程id"2031295" 
            nameValueCollection.Add("__", "GetTargetTimeAvaDuration");
            try
            {
                var result = webClient.UploadValues("https://www.acadsoc.com.cn/Ajax/Web.UI.Fun.Course.aspx?method=GetTargetTimeAvaDuration&_timestamp=" + _timestamp, "POST", nameValueCollection);
                var str = System.Text.Encoding.UTF8.GetString(result);

                Console.ForegroundColor = ConsoleColor.Yellow;
                Console.WriteLine(str);
                Console.ResetColor();
                CBResponse<Dictionary<DateTime, dynamic>> keyValuePairs = Newtonsoft.Json.JsonConvert.DeserializeObject<CBResponse<Dictionary<DateTime, dynamic>>>(str);
